...
| **Phase 7** — Daily-Driver & Platform Roadmap | 6 tracks | **Scheduled (2026-06-06).** Track A started: **Morning Brief digest shipped** (`morning-brief:get` aggregator + Dashboard card + optional daily scheduled notification); remaining Track A (evening/weekly review, global+voice quick-capture) + Tracks B–F still open. See § Phase 7. |
